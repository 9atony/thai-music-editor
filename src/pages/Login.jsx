            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              {isSignUp && (
                <div className="animate-fadeIn">
                  <label htmlFor="display-name" className="block text-sm font-bold text-slate-700 mb-1.5">ชื่อผู้ใช้</label>
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-bold text-slate-700 mb-1.5">อีเมล</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
              ...
              <div>
                <label htmlFor="password" className="block text-sm font-bold text-slate-700 mb-1.5">รหัสผ่าน</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
              ...
              {isSignUp && (
                <div className="animate-fadeIn">
                  <label htmlFor="confirm-password" className="block text-sm font-bold text-slate-700 mb-1.5">ยืนยันรหัสผ่าน</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
