      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-500">
              <li>
                <a href="https://www.facebook.com/share/g/1D1FvNehDM/" target="_blank" rel="noreferrer" className="hover:text-blue-600 transition-colors">
                  เข้าร่วมกลุ่ม Facebook
                </a>
              </li>
              <li>
                <a href="https://www.facebook.com/ratn.chay.sakdi.cay/" target="_blank" rel="noreferrer" className="hover:text-blue-600 transition-colors">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center border-t border-gray-100 pt-8">
          ...
          <div className="flex gap-4 items-center">
            ...
            {/* Facebook Group Icon */}
            <a href="https://www.facebook.com/share/g/1D1FvNehDM/" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-blue-600 transition transform hover:scale-110" title="เข้าร่วมกลุ่ม Facebook">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
              </svg>
            </a>
            {/* YouTube Icon */}
            <a href="https://www.youtube.com/@ThaiMusicEditor" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-red-600 transition transform hover:scale-110" title="ช่อง YouTube ของ Thai Music Editor">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
