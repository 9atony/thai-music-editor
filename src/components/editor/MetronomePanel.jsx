...
const MetronomePanel = ({ isExpanded }) => {
  ...
  return <section className="border-t border-slate-200 bg-gradient-to-b from-slate-50 to-white px-2 py-2 sm:px-4" aria-label="เครื่องประกอบจังหวะ">
    <div className="w-full overflow-x-auto pb-1 custom-scrollbar">
      <div className="flex min-w-[1360px] items-center rounded-xl border border-slate-200 bg-white px-2 py-1.5 shadow-sm">
        <div className="flex w-[132px] shrink-0 items-center gap-1.5 px-1.5 pr-3"><span className="flex h-6 w-6 items-center justify-center rounded-md bg-indigo-100 text-indigo-600"><AudioLines size={14} /></span><span className="text-[11px] font-black tracking-wide text-slate-700">เครื่องจังหวะ</span></div>
