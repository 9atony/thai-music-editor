          ...
          return (
            <div
              ...
              className={`flex items-center justify-between p-4 rounded-2xl bg-white border transition-all ${
                isCurrent
                  ? 'border-sky-300 shadow-[0_8px_20px_rgba(14,165,233,0.15)] scale-[1.02]'
            ...
            >
              <div className="flex items-center gap-4 flex-1 overflow-hidden">
                ...
                <div className="overflow-hidden">
                  <p className={`font-black truncate ${isCurrent ? 'text-sky-600' : 'text-slate-700'}`}>
                    {item.label}
                  </p>
              ...
              <div className="flex items-center gap-3 shrink-0 ml-3">
                ...
                <button
                  onClick={() => removeSeqItem(idx)}
                  className="text-rose-300 hover:text-rose-500 p-1.5 transition-colors bg-rose-50 rounded-lg"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
